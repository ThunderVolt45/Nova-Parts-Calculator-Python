...
현재 빌드는 PyInstaller의 단일 실행 파일 배포 방식입니다. GitHub Release에는 `dist\NovaPartsCalculator.exe`를 첨부하면 됩니다.
...
2. GitHub Release를 생성하고 `dist\NovaPartsCalculator.exe`를 첨부합니다.
3. 릴리스 노트에는 변경된 기능, 수정된 버그, 알려진 문제를 정리합니다.
